...
export default function Doctors() {
    ...
    function AddDoctors(e) {
        ...
        axios
            .post("http://localhost:8080/AddDoctors", data)
            .then((res) => {
        ...
        <div>
            <div className='container'>
                <div className="col-sm-10 mt-5 offset-1">
                    <div className='card'>
                        <div className="">
                            <h3 className='text-center mt-2'>Add Doctors</h3>
                        </div>
                        <hr />
                ...
                <div className="col-sm-10 mt-5 lbl offset-1">
                    <div className="card">
                        <div className=" text-center bg-danger text-white">
                            <h4 className="text-center mt-2"> Added Doctors </h4>
                        </div>
                    </div>
