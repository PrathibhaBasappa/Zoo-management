...
export default function InchargeProfile() {
  ...
  function updateinchargeprofile(e) {
      ...
      axios
          .put(`http://localhost:8080/updateinchargeprofile/${iemail}`, data)
          .then((res) => {
  ...
  function GetIncharge() {
      ...
      axios.get(`http://localhost:8080/GetInchargebtemail/${iemail}`)
          .then((res) => {
          ...
          <div className='container'>
              <div className="col-sm-10 mt-5 offset-1">
                  <div className='card'>
                      ...
                      <form onSubmit={updateinchargeprofile}>
